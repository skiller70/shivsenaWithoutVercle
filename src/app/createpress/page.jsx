...
function Page() {
    ...
    // RESPONSE MESSAGE
    const notifySuccess = () => toast.success("press upload successfully");
    const notifyError = () => toast.error("faild to upload press");
    // RESPONSE MESSAGE
    ...
    const handleUpload = async (e) => {
        ...
        try {
            const result = await axios.post("http://localhost:4000/createpresss", data)
    ...
    return (
        <div className=" ">
            ...
            <h1 className=' text-2xl mt-8  text-center'>CREATE PRESS !</h1>
