...
function page() {
    return (
        <div>
            ...
            <Story title="Shewale Rahul Ramesh" text="Rahul Shewale is an active Indian politician from the Shiv Sena and the Lok Sabha member from the Mumbai South Central constituency. He defeated sitting MP Eknath Gaikwad in the Indian general election, 2014. Shewale is a four-time chairman of the standing committee of the Brihanmumbai Municipal Corporation (BMC), the municipal corporation of the city of Mumbai. He held the position from 2010 to 2014." img={"/rahulNew.jpg"} />
